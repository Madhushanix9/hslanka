		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					...
					<th class="text-left" width="15%">{{$receipt_details->table_qty_label}}</th>
					<th class="text-left" width="15%">{{$receipt_details->table_unit_price_label}}</th>
			...
			@if( !empty($receipt_details->discount) )
				<div class="flex-box">
					...
					<p class="width-50 text-right">
						<strong>(-) {{$receipt_details->discount}}</strong>
					</p>
				</div>
			@endif
			...
			@if( !empty($receipt_details->total_line_discount) )
				<div class="flex-box">
					...
					<p class="width-50 text-right">
						<strong>(-) {{$receipt_details->total_line_discount}}</strong>
					</p>
				</div>
			@endif
