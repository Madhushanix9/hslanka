<div class="row" id="all_products_box" style="display: none;">
@if(!empty($all_products))
	@include('sale_pos.partials.all_products')
@endif
</div>
<div class="row">
	...
	<div class="col-sm-4 @if(empty($all_products)) hide @endif" id="all_product_div">
		<button type="button" class="btn btn-primary btn-flat" id="show_all_products">@lang('lang_v1.all_products')</button>
	</div>
</div>
<br>
<div class="row">
