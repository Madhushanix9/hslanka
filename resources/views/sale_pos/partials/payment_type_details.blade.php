...
<div class="payment_details_div @if( $payment_line['method'] !== 'hela_qr' ) {{ 'hide' }} @endif" data-type="hela_qr" >
	<div class="col-md-12">
		<div class="text-center">
			<button type="button" class="btn btn-primary btn-lg generate_helapos_qr">
				<i class="fas fa-qrcode"></i> Generate HelaPOS QR
			</button>
			<div class="helapos_qr_display" style="margin-top: 10px;"></div>
			<div class="helapos_status_display" style="margin-top: 10px;"></div>
		</div>
	</div>
</div>