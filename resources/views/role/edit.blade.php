      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'outstanding_report.view', in_array('outstanding_report.view', $role_permissions), 
        ...
        <div class="row">
        <div class="col-md-12">
           <button type="submit" class="btn btn-primary pull-right" style="	background: linear-gradient(90deg, #042761 0%, rgba(4,153,209,1) 100%);">@lang( 'messages.update' )</button>
        </div>
        </div>
