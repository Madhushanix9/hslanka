                        ...
                        <div class="row">
                            ...
                            @foreach($stock_details as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a id="autoClickLink" href="{{action('ReportController@adjustProductStock')}}?location_id={{$location->id}}&variation_id={{$row->variation_id}}&stock={{$row->total_stock_calculated}}" class="btn btn-primary">Fix</a>
                                    </td>
                                </tr>
                            @endforeach
                            </table>
