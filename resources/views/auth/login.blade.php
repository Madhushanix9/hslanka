...
<style>
    ...
    <div class="login-form col-md-12 col-xs-12">
        ...
        <div class="card form-box">
            <div class="card-body">
                <h1 class="text-white">@lang('lang_v1.login')</h1>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-sm-6" >
                                <button type="submit" class="btn btn-success btn-lg btn-block btn-login">@lang('lang_v1.login')</button>
                            </div>
                            <div class="col-md-6 col-sm-6" >
                                {{-- @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register')) --}}
                                @if(config('constants.allow_registration'))
                                <a href="{{ route('business.getRegister') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif">
                                    <button type="button" class="btn btn-danger btn-lg btn-block btn-login">@lang('business.register_now')</button>
                                </a>
                                @endif
                                {{-- @endif --}}
                            </div>
